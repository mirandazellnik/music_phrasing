...
from util.format_dataset import format_dataset
...
train_ds, val_ds, test_pairs, notes_vectorization = format_dataset(data_path, vocab_size_notes, sequence_length, num_samples, batch_size)
...
if train:
    ...
    model.fit(train_ds, validation_data=val_ds, epochs=200, verbose=2, callbacks=[tensorboard, early_stop])
